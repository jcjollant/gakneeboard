...
export class TemplateService {
    ...
    public static async getVersion(templateId: number, version: number, requester: number): Promise<TemplateView | undefined> {
        ...
        // If it returned nothing, it means not found or not owned.
        // In either case, if we are here, we didn't find the version.

        throw new GApiError(404, 'Version not found')
    }
