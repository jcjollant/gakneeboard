...
export const adminUserId = jcUserId
export const asUserId = 2
export const nonAdminUserId = asUserId
...
export const jcMaxTemplates = 30
export const jcTestTemplate = { id: 0, name: jcTestTemplateName, publish: false, data: jcTestTemplateData }
...
export const currentAsOf = 20250710;
export const currentAirportModelVersion = 11
