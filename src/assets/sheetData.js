...
const page0DemoChecklist = { type:PageType.checklist,data:{name:'Preflight',theme:'yellow',items:[{s:'Cabin'},{c:'Docs AR(R)OW',r:'CHECKED'},{c:'Control Wheel Lock + Pitot Cover',r:'REMOVED'},{c:'Kneeboard, Eyewear',r:'READY'},{c:'Headset, iPad',r:'INSTALLED'},{c:'Sentry, Camera, Power Bank',r:'INSTALLED'},{c:'Section 3',r:'READY'},{c:'Fire Extinguisher',r:'LATCHED'},{s:'Panel'},{c:'Ignition Switch',r:'OFF'},{c:'Avionics',r:'OFF'},{c:'Master Batt',r:'ON'},{c:'Lights + Pitot Heat',r:'ON'},{c:'Flaps',r:'FULL'},{s:'Walk Around'},{c:'All Lights',r:'CHECKED'},{c:'Antenas (Comm, ELT, Nav, GPS, OAT)',r:'CHECKED'},{c:'Wings (Frost, Ice)',r:'CLEAR'},{c:'Windshield',r:'CLEAN'},{c:'Pitot Tube',r:'HOT'},{s:'Panel'},{c:'Lights + Pitot Heat',r:'OFF'},{c:'Fuel Quantity',r:'CHECKED'},{c:'Hobbs & Tach',r:'RECORD'},{c:'Master Switches',r:'OFF'},]}}
const page1DemoChecklist = { type:PageType.checklist,data:{name:'Preflight (Cont\'d)',theme:'yellow',items:[{s:'Tail'},{c:'Tie Down',r:'REMOVED'},{c:'Control Surface',r:'CHECKED'},{s:'Right Wing'},{c:'Tie Down',r:'REMOVED'},{c:'Control Surface',r:'CHECKED'},{c:'Main Tire, Wheel Pin, Brake Pad',r:'CHECKED'},{s:'Nose'},{c:'Engine Oil (8qt for long flight)',r:'> 6qt'},{c:'Prop & Spinner',r:'CHECKED'},{c:'Engine Air Inlets / Belt',r:'CHECKED'},{c:'Air Filter',r:'CHECKED'},{c:'Static Source',r:'CHECKED'},{c:'Front Tire / Shock',r:'CHECKED'},{s:'Left Wing'},{c:'Tie Down',r:'REMOVED'},{c:'Control Surface',r:'CHECKED'},{c:'Main Tire, Wheel Pin, Brake Pad',r:'CHECKED'},{c:'Fuel Vent',r:'CHECKED'},{c:'Stall Warning',r:'CHECKED'},{s:'Fuel Test'},{c:'Drain x13 + Smell',r:'TEST'},{c:'Dipstick measure x2',r:'BOTH'},{c:'Fuel Cap Seal x2',r:'CHECKED'},{c:'Fuel Cap Secured x2',r:'CHECKED'},]}}
const page2DemoChecklist = { type:PageType.checklist,"data":{"name":"Flight","items":[{"s":"Climb","t":"strong"},{"c":"Power","r":"FULL"},{"c":"Mixture","r":"RICH"},{"c":"Flaps","r":"UP"},{"c":"Engine","r":"GREEN"},{"c":""},{"c":""},{"s":"Approach","t":"strong"},{"c":"Direct","r":"SET"},{"c":"ATIS","r":"GET"},{"c":"Altimeter","r":"SET"},{"c":"RWY HDG","r":"SET"},{"c":"Calls","r":"MADE"},{"c":"Briefing","r":"DONE"},{"c":""},{"s":"Engine FAILURE","t":"emer"},{"c":"Airspeed","r":"68"},{"c":"Fuel Pump","r":"ON"},{"c":"Mixture","r":"RICH"},{"c":"Fuel Shutoff","r":"ON"},{"c":"Fuel Selector","r":"BOTH"},{"c":""},{"s":"Engine FIRE","t":"emer"},{"c":"Mixture","r":"CUTOFF"},{"c":"Fuel Shutoff","r":"OFF"},{"c":"Fuel Pump","r":"OFF"},{"c":"Masters","r":"OFF"},{"c":"Vents, Heat, Air","r":"CLOSED"},{"c":"Emergency Descent","r":"120@30"},{"c":""}],"items2":[{"s":"Cruise","t":"strong"},{"c":"Power","r":"SET"},{"c":"Flaps","r":"UP"},{"c":"Trim","r":"SET"},{"c":"Heading","r":"BUGGED"},{"c":""},{"c":""},{"s":"Before Landing","t":"strong"},{"c":"Fuel Selector","r":"BOTH"},{"c":"Mixture","r":"RICH"},{"c":"Landing Lights","r":"ON"},{"c":"Safety Belts","r":"ON"},{"c":"Auto Pilot","r":"OFF"},{"c":"Cabin Power","r":"OFF"},{"c":""},{"s":"After Landing"},{"c":"Flaps","r":"UP"},{"c":"Light","r":"TAXI"},{"c":"Mixture","r":"Lean"},{"c":"Trim","r":"T/O"},{"c":"Pitot","r":"OFF"},{"c":"Comms","r":"GND"},{"c":""},{"s":"Shutdown"},{"c":"Avionics","r":"OFF"},{"c":"Mixture","r":"IDLE"},{"c":"Magnetos","r":"OFF"},{"c":"Electrical Equipment","r":"OFF"},{"c":"Hobbs & Tach","r":"RECORD"},{"c":"Master & Stby","r":"OFF"}],"theme":"blue"}}
const page3DemoChecklist = { type:PageType.checklist,"data":{"name":"Emergencies","items":[{"s":"ENGINE FAILURE","t":"strong"},{"c":"Airspeed","r":"68"},{"c":"Fuel Pump","r":"ON"},{"c":"Mixture","r":"RICH"},{"c":"Fuel Shutoff","r":"ON"},{"c":"Fuel Selector","r":"Both"},{"c":""},{"s":"ENGINE FIRE","t":"emer"},{"c":"Mixture","r":"CUTOFF"},{"c":"Fuel Shutoff","r":"OFF"},{"c":"Fuel Pump","r":"OFF"},{"c":"Masters","r":"OFF"},{"c":"Vents, Heat, Air","r":"CLOSED"},{"c":"Emerg. Descent","r":"120@30°"},{"c":""},{"s":"CABIN FIRE","t":"emer"},{"c":"Stby Batt.","r":"OFF"},{"c":"Masters","r":"OFF"},{"c":"Vents, Heat, Air","r":"CLOSED"},{"c":"Fire Ext.","r":"ACTIVATE"},{"c":""},{"s":"EMERGENCY LANDING","t":"strong"},{"c":"Airspeed 68 Trimmed"},{"c":"Best Field (Consider Winds)"},{"c":"Checklist"},{"c":"Declare 121.5+XPDR 7700 + ELT"},{"c":"Seats","r":"SECURE"},{"c":"Belts","r":"ON"},{"c":"Doors","r":"UNLATCH"},{"c":""}],"items2":[{"s":"ICING","t":"strong"},{"c":"Pitot Heat","r":"ON"},{"c":"Altitude","r":"WARM"},{"c":"Cabin Heat","r":"FULL"},{"c":"Defrost Vent","r":"OPEN"},{"c":"Cabin Air","r":"OPEN"},{"c":""},{"s":"ELECTRICAL FIRE","t":"emer"},{"c":"Stby Batt","r":"OFF"},{"c":"Masters","r":"OFF"},{"c":"Vents, Heat, Air","r":"CLOSED"},{"c":"Fire Ext.","r":"ACTIVATE"},{"c":"Avionics","r":"OFF"},{"c":"Electrical Equip.","r":"OFF"},{"c":"Vents, Heat, Air","r":"OPEN"},{"s":"WING FIRE","t":"emer"},{"c":"Wing Lights","r":"OFF"},{"c":"Pitot Heat","r":"OFF"},{"c":""},{"c":""},{"c":""},{"s":"WATER DITCHING","t":"strong"},{"c":"Flaps","r":"20"},{"c":"Airspeed","r":"55kts"},{"c":"Heading","r":"UPWIND"},{"c":"Doors","r":"UNLATCH"},{"c":"Touchdown","r":"LEVEL"},{"c":"ELT","r":"Activate"}],"theme":"blue"}}

const templateDemoChecklist = new Template('Checklist Demo', 'A C172 preflight Checklist', false, [page0DemoChecklist,page1DemoChecklist,page2DemoChecklist,page3DemoChecklist])
