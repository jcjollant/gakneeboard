<template>
    <Dialog modal :header="'Hey ' + currentUser.name + ', a personal note to you'" style="width: 600px">
        <p class="mb-1">As Pilots, we know what keep us aloft : Lift, Thrust, Fuel and Money. 
        ...
        <p>
            As we speak, you are over the free plan by <b>{{ overage.join(' and ') }}</b>. Please consider what works best for you.
        </p>
        <p>
