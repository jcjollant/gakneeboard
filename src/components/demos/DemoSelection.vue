<script setup>
import { getTemplateDemo, getTemplateDemoChecklist, getTemplateDemoNavlog, getTemplateDemoTiles } from '../../assets/sheetData';
...
<template>
  <Dialog modal header="GA Kneeboard Demos">
    <div class="demoGrid">
